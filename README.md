...
[![license](https://img.shields.io/github/license/goswinr/Fesh.AutoCAD)](LICENSE.md)

Fesh.AutoCAD is an F# scripting editor hosted inside AutoCAD. It is based on [Fesh](https://github.com/goswinr/Fesh).<br>
